...
/* ── Mobile: nav barra ── */
@media(max-width:640px){
  .ge-nav-bar{overflow-x:auto!important;overflow-y:visible!important;flex-wrap:nowrap!important;-webkit-overflow-scrolling:touch;scrollbar-width:thin;scrollbar-color:#CBD5E1 transparent;gap:4px!important;margin-bottom:8px!important}
  .ge-nav-bar::-webkit-scrollbar{height:3px}
  .ge-nav-bar::-webkit-scrollbar-track{background:transparent}
  .ge-nav-bar::-webkit-scrollbar-thumb{background:#CBD5E1;border-radius:99px}
